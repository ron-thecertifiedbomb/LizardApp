  ...
  const mutation = useMutation(
    ...
    },
    {
      onSuccess: data => {
        ...
        const lastLoggedIn = data.lastLoggedInTime;
        const serverMessage = data.message;
        // const formattedLastLoggedIn = new Date(lastLoggedIn).toLocaleString();
        logger('Last Logged in Time', lastLoggedIn);
        logger('Server Message', serverMessage);
