...
const refetchUserCartListApiListenerMiddleware = createListenerMiddleware();

refetchUserCartListApiListenerMiddleware.startListening({
...
export default refetchUserCartListApiListenerMiddleware;
